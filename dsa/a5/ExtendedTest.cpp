...
void testValueRange() {
	...
	// Values are: 10, 5, 20, 15 => min = 5, max = 20 => range = 15
	assert(smm.getValueRange() == 15);

	// Add more values including duplicates
	smm.add(1, 5);
	smm.add(2, 20);

	// New values: 10, 5, 20, 15, 5, 20 => min = 5, max = 20 => range = 15
	assert(smm.getValueRange() == 15);

	cout << "getValueRange passed." << endl;
}
